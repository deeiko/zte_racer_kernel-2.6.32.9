...
#define TS_PENUP_TIMEOUT_MS 20 // 20  -->  70  ZTE_TS_ZT_005 @2010-03-05
...
static irqreturn_t msm_ts_irq(int irq, void *dev_id)
{
  ...
  //del_timer_sync(&ts->timer);
	...
	if ((x==1001)&&(y>970))
	{
		if (31 == irq)disable_irq_nosync(irq);
		...
		input_sync(ts->input_dev);
		//racer_flag = false;
		if (31 == irq)mod_timer(&ts->timer,jiffies + msecs_to_jiffies(TS_PENUP_TIMEOUT_MS));
		return IRQ_HANDLED;
	}
...
//static const char ts_keys_size[] = "0x01:102:30:340:60:50:0x01:139:120:340:60:50:0x01:158:258:340:60:50";
